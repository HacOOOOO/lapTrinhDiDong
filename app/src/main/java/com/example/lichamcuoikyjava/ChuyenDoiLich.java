...
public class ChuyenDoiLich extends RecyclerView.Adapter<KhungNhin> {
    private final ArrayList<String> ngayCuaThang;
    private final OnItemListener onItemListener;

    public ChuyenDoiLich(ArrayList<String> ngayCuaThang, OnItemListener onItemListener) {
    ...
    public KhungNhin onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.lich_o, parent, false);
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        layoutParams.height = (int) (parent.getHeight()*0.166666666);
        return new KhungNhin(view, onItemListener);
    }
